...
# PAra unir los datos con el left y st; join
...
# Lista ordenada de lista roja con un elemento adicional = "Todas"
...
# Lista ordenada de regiones con un elemento adicional = "Todas"
...
# Widget de lista de selección de regiones 
selectInput(
...
```{r}
#| label: salida-tabla
#| title: "Tabla de registro de presencia"
...
```{r}
#| label: salida-mapa
#| title: "Mapa de registro de presencia y regiones socioeconómicas"
...
#| title: "Gráfico de barras de cantidad de registro de presencia en regiones socioeconómicas"
...
colores_especies <- colorFactor(
  ...
  leaflet() |>
    setView(lng = -84.194552, lat = 9.572735, zoom = 7) |>
